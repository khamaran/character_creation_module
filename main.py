...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляет силу урона для каждого класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет уровень блокировки атак для каждого класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Вычисляет силу и тип специального умения для каждого класса."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит описания класса и описание всех доступных функций."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбираем тип класса: воитель, маг или лекарь."""
